...
class Navbar extends Component {
    ...
    render() {
        ...
        return (
            <>
                <nav id="navbar" className="navbar fixed-top navbar-expand-lg main-navbar app-nav">
                    <div className="container">
                        <Link href="/app-landing">
                        ...
                        <div className={classOne} id="navbarSupportedContent">
                            ...
                            <div className="nav-btn">
                                <a href="https://www.apple.com/app-store/" className="default-btn bg-main" target="_blank">Download</a>
                            </div>
                        </div>
                    </div>
                </nav>
